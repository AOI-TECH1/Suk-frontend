  ...
  return (
    <div className="pt-32 pb-20 max-w-7xl mx-auto px-6 font-sans">
      ...
      <div className="flex justify-between items-center mb-12">
        <h1 className="text-4xl font-[900]  uppercase tracking-tighter">Identity <span className="text-[#fbb03b]">Control</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filtered.map(u => (
          <div key={u.id} className="bg-white border border-gray-100 p-8 rounded-[40px] hover:shadow-xl transition-all">
             ...
             <h3 className="font-[900] text-zinc-900 uppercase  text-lg leading-none">{u.full_name}</h3>
