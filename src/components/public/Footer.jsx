  ...
  return (
    <footer className="w-full font-sans bg-[#0a0c0c]">
      ...
      <div className="bg-[#0a0c0c] text-white pt-16 pb-12 relative overflow-hidden">
        ...
        {/* Background Decorative Cart Watermark */}
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              ...
              <ul className="footer-list text-xs font-black">
            ...
            <div>
              ...
              <ul className="footer-list text-xs font-black">
                ...
                <li><Link to="/cart">Cart <span className="text-[#fbb03b] ml-1">✔</span></Link></li>
                <li><Link to="/wishlist">Wishlist</Link></li>
              </ul>
              <div className="mt-8">
                <p className="text-[10px] text-gray-500 uppercase font-black mb-3 tracking-widest">Download App</p>
                <div className="flex gap-2">
                  <a href="#" className="w-24 hover:scale-105 transition-transform"><img src={play} alt="Google Play" className="w-full opacity-80 hover:opacity-100 transition-opacity" /></a>
                  <a href="#" className="w-24 hover:scale-105 transition-transform"><img src={app_store} alt="App Store" className="w-full opacity-80 hover:opacity-100 transition-opacity" /></a>
                </div>
              </div>
            </div>
            ...
            {/* COL 5: SUBSCRIBE */}
            <div>
              <h4 className="text-[#fbb03b] text-xl font-black italic mb-4 uppercase tracking-tighter">SuK News</h4>
              <p className="text-[11px] text-gray-400 mb-4 leading-relaxed font-medium">Subscribe to get the latest arrivals and SuK deals.</p>
              <div className="relative">
                <input 
                  type="email" 
                  placeholder="Enter email" 
                  className="w-full bg-white/5 border border-white/20 rounded-md py-2.5 px-3 text-xs focus:border-[#fbb03b] outline-none transition-all placeholder:text-gray-600"
                />
      ...
      <div className="bg-[#fbb03b] py-5 text-center flex items-center justify-center">
      ...
      {/* Internal CSS for premium interaction */}
      <style dangerouslySetInnerHTML={{ __html: `
        .footer-title { color: #fbb03b; font-weight: 900; text-transform: uppercase; font-size: 0.7rem; letter-spacing: 0.15em; margin-bottom: 1.5rem; }
        .footer-list { list-style: none; padding: 0; display: flex; flex-direction: column; gap: 0.8rem; }
        .footer-list a { color: #9ca3af; text-decoration: none; text-transform: uppercase; transition: all 0.3s; cursor: pointer; }
        .footer-list a:hover { color: white; padding-left: 6px; }
      `}} />
    </footer>
  );
};
...
const Feature = ({ icon, title, desc }) => (
  <div className="flex flex-col items-center text-center group cursor-default">
    <div className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center mb-4 transition-all group-hover:bg-[#fbb03b] group-hover:text-black shadow-lg">
      {icon}
    </div>
...
const SocialLink = ({ icon, link }) => (
  <a 
    ...
    className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-[#fbb03b] hover:border-[#fbb03b] hover:bg-white/5 transition-all"
  >
    {icon}
  </a>
);
